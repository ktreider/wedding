...
import maryParking from './../../images/maryParking3.webp';
    ...
    <>
      ...
      <div className="details">
        ...
        <div className="accomodations"> 
          ...
          <p id="misc">Find the following hotels halfway between Conshohocken and Quakertown - under an hour from the Philadelphia International Airport (PHL).</p>
        ...
        <div className="wedding-party"> 
          ...
          <div className="people">
            ...
            <div className="guys">
              <div className="person-img">
                  <img className="small-img" src={tony} alt='Tony' loading="lazy"/>
                ...
                <div className="person-img">
                  <img className="small-img" src={JW} alt='Jacob W' loading="lazy"/>
                ...
                <div className="person-img">
                  <img className="small-img" src={JF} alt='Jacob F' loading="lazy"/>
                ...
                <div className="person-img">
                  <img className="small-img" src={mike} alt='Mike' loading="lazy"/>
        ...
        <div className="other"> 
          ...
          <div className="information">
            ...
            <img className="map-img" src={maryParking} alt="Parking Map" loading="lazy"/>
